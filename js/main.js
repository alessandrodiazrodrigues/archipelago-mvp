...
window.refreshAfterAction = async function() {
    try {
        ...
        } else if (window.currentView === 'viewEnfermeiro' && window.renderViewEnfermeiro) { // V8.0
            const h = window.getHospitalPerfil ? window.getHospitalPerfil() : window.currentHospital;
